...
.controller('AppCtrl', function($scope, $interval, $ionicPlatform, $ionicSideMenuDelegate, RecipeSrv, UserSrv){
  'use strict';
...
.controller('HomeCtrl', function($scope, $timeout, $window, $ionicPlatform, GlobalMessageSrv, CartSrv, RecipeSrv, WeekrecipeSrv, LogSrv){
  'use strict';
  $ionicPlatform.ready(function(){
